...
for id in list(df.screen_name)[:]:    
    ...
    try:
        ...
        rythm = (most_recent_date-least_recent_date).days+1
        tweets_content.append([int(freshness/365*12),int(len(tweets_df)*365/rythm),frcount])
        
    except:
        tweets_content.append([20,0,0])
        print (id,'out',end=' ')
